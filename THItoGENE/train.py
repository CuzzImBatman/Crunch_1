...
from dataset import ViT_HER2ST,DATA_BRAIN
...
def train(test_sample_ID, vit_dataset, epochs, modelsave_address, dataset_name):
    ...
    if dataset_name == "her2st":
        ...
        model = THItoGene(n_genes=460, learning_rate=1e-5, route_dim=64, caps=20, heads=[16, 8], n_layers=4)
    else:
...
if __name__ == '__main__':
    ...
    # for i in range(0, 32):
    train(0, DATA_BRAIN, 300, "model", "her2st")
