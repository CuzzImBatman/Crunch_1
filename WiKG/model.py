...
class WiKG(nn.Module):
    ...
    def forward(self, x):
        ...
        Nb_h = e_t[batch_indices, topk_index_expanded, :]  # Neighbors
        # print(f"e_t: {e_t.shape}, topk_index: {topk_index.shape}, Nb_h: {Nb_h.shape}")
...
if __name__ == "__main__":
    ...
    data = torch.randn((7, 3, 224, 224)).to(device)
    # data = torch.randn(( 1,1000, 1024)).to(device)
