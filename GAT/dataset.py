...
class CLUSTER_BRAIN(torch.utils.data.Dataset):
    ...
    def __init__(self, emb_folder=f'E:/DATA/crunch/tmp/preprocessed',cluster_path= 'E:/DATA/crunch/tmp/cluster', augmentation=True,encoder_mode=False, random_seed=1234, train=True, split= False,
        ...
        for name in NAMES:
            ...
            if split== True:
                cluster_dir=f'{cluster_path}/train/cluster_data_split'
            elif train == False:
